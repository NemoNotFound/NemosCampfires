...
public class CampfiresTextureMapping {
    ...
    public static TextureMapping cobblestoneCampfire() {
        return new TextureMapping()
                .put(CampfiresTextureSlot.CAMPFIRE_EMBER, new Material(Identifier.fromNamespaceAndPath(MOD_ID, "block/campfire_ember")))
                .put(TextureSlot.FIRE, new Material(Identifier.withDefaultNamespace("block/campfire_fire")));
    }
    ...
    public static TextureMapping cobblestoneSoulCampfire() {
        return new TextureMapping()
                .put(CampfiresTextureSlot.CAMPFIRE_EMBER, new Material(Identifier.fromNamespaceAndPath(MOD_ID, "block/soul_campfire_ember")))
                .put(TextureSlot.FIRE, new Material(Identifier.withDefaultNamespace("block/soul_campfire_fire")));
    }
    ...
    private static TextureMapping customFlameCampfire(Block customFlameCampfireVariant, Block campfireVariant, String firePath) {
        return new TextureMapping()
                ...
                .put(TextureSlot.FIRE, new Material(Identifier.fromNamespaceAndPath(MOD_ID, "block/" + firePath)))
                .put(CampfiresTextureSlot.LOG, getBlockTexture(campfireVariant, "_log"))
                .put(TextureSlot.PARTICLE, getBlockTexture(campfireVariant, "_log"));
    }
    ...
    private static TextureMapping customFlameCobblestoneCampfire(String campfireEmberPath, String firePath) {
        return new TextureMapping()
                .put(CampfiresTextureSlot.CAMPFIRE_EMBER, new Material(Identifier.fromNamespaceAndPath(MOD_ID, "block/" + campfireEmberPath)))
                .put(TextureSlot.FIRE, new Material(Identifier.fromNamespaceAndPath(MOD_ID, "block/" + firePath)));
    }
}
