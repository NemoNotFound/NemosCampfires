...
public class FabricNemosCampfires implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        BlockEntityType.CAMPFIRE.addSupportedBlock(NemosCampfiresBlocks.COBBLESTONE_CAMPFIRE.get());
        ...
        BlockEntityType.CAMPFIRE.addSupportedBlock(NemosCampfiresBlocks.COBBLESTONE_SOUL_CAMPFIRE.get());
        ...
        BlockEntityType.CAMPFIRE.addSupportedBlock(NemosCampfiresBlocks.COBBLESTONE_COPPER_CAMPFIRE.get());
        ...
        BlockEntityType.CAMPFIRE.addSupportedBlock(NemosCampfiresBlocks.COBBLESTONE_REDSTONE_CAMPFIRE.get());
        ...
        BlockEntityType.CAMPFIRE.addSupportedBlock(NemosCampfiresBlocks.COBBLESTONE_LAPIS_CAMPFIRE.get());
        ...
        BlockEntityType.CAMPFIRE.addSupportedBlock(NemosCampfiresBlocks.COBBLESTONE_QUARTZ_CAMPFIRE.get());
    }
}
