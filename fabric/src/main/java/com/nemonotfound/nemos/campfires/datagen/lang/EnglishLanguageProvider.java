...
public class EnglishLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(NemosCampfiresBlocks.PALE_OAK_QUARTZ_CAMPFIRE.get(), "Pale Oak Quartz Campfire");
        translationBuilder.add(NemosCampfiresBlocks.CRIMSON_QUARTZ_CAMPFIRE.get(), "Crimson Quartz Campfire");
        translationBuilder.add(NemosCampfiresBlocks.DARK_OAK_QUARTZ_CAMPFIRE.get(), "Dark Oak Quartz Campfire");
        translationBuilder.add(NemosCampfiresBlocks.JUNGLE_QUARTZ_CAMPFIRE.get(), "Jungle Quartz Campfire");
        translationBuilder.add(NemosCampfiresBlocks.MANGROVE_QUARTZ_CAMPFIRE.get(), "Mangrove Quartz Campfire");
